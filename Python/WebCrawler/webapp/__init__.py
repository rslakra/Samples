...
class WebApp:
    ...
    def create_app(self, config_class: Config = Config, test_mode: bool = False) -> Flask:
        ...
        """
        Create an instance of Blueprint prefixed with '/web-crawler' as named bp.
        Parameters:
            ...
            url_prefix: the web url prefixed with '/web-crawler'
        """
        bp = Blueprint("ws", __name__, url_prefix="/web-crawler")
