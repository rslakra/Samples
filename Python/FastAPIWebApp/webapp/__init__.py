...
from framework.logger import RequestIdFilter
...
class WebApp(FastAPI):
    ...
    def __init__(self: AppType, testMode: bool = False):
        self.testMode = testMode
        super.__init__(self, debug=testMode)
        self.path = Path()
    ...
    def create_app(self, test_mode: bool = False) -> FastAPI:
        """
